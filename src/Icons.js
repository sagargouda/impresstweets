...
export const ViewBox = ({color,width , height }) =>{
    return (
        <>
            <svg fill={color || 'white'} width={width} height={height} viewBox="0 0 24 24" aria-hidden="true">
                <g>
                    <path
...
export const CommentBox = ({color, width, height}) => {
    return (
        <svg fill={color || 'white'} width={width} height={height} viewBox="0 0 24 24" aria-hidden="true">
            <g>
                <path
...
export const RepostBox = ({color , width , height}) =>{
    return (
        <svg fill={color || 'white'} width={width} height={height} viewBox="0 0 24 24" aria-hidden="true">
            <g>
                <path
...
export const LikeBox = ({color , width , height})=>{
    return (
        <svg fill={color || 'white'} width={width} height={height} viewBox="0 0 24 24" aria-hidden="true">
            <g>
                <path
...
export const SaveBox = ( {color , width , height}) =>{
    return (
        <svg fill={color || 'white'} width={width} height={height} viewBox="0 0 24 24" aria-hidden="true">
            <g>
                <path
...
export const DownloadBox  = ({color , width , height}) =>{
    return (
        <svg fill={color || 'white'} width={width} height={height} viewBox="0 0 24 24" aria-hidden="true">
            <g>
                <path
